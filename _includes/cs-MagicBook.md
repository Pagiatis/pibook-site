...
- Με μια απλή κίνηση (π.χ. ένα κουμπί ή μια συγκεκριμένη κίνηση), οι χρήστες περνούν από το AR στο VR και αντίστροφα, χωρίς να υπάρξει διακοπή της εμπειρίας.
...
- Το MagicBook είναι κατανοητό ακόμη και σε αρχάριους χρήστες, γιατί βασίζεται σε βασικές και οικείες για τους χρήστες συσκευές και λειτουργίες όπως γυαλιά ανάγνωσης μελέτη βιβλίου κτλ.
